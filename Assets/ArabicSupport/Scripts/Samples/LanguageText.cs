...
namespace UnityEngine.UI
{
    public class LanguageText : Text
    {
        ...
        public static bool isArabicLanguage = true;
        ...
        //struct TextBlock
        //{
        //    public TextBlock(string text, string tag = "")
        //    {
        //        this.tag = tag;
        //        this.text = text;
        //    }
        ...
        //    public string text;
        //}
        //private string FixRichTextColor(string str)
        //{
        //    string[] stringSeparators = new string[] { Environment.NewLine };
        //    string[] strSplit = str.Split(stringSeparators, StringSplitOptions.None);
        //    Stack<string> tagStack = new Stack<string>();
        ...
        //        if (ArabicFixerTool.IsRtl(strSplit[i]))
        //        {
        //            MatchCollection matches = Regex.Matches(strSplit[i], @"<[^>]*color(/)?>");
        //            int cPos = strSplit[i].Length;
        //            for (int j = matches.Count - 1; j >= 0; j--)
        //            {
        //                var tag = matches[j].Value;
        ...
        //                {
        //                    block = new TextBlock(text, tagStack.Peek());
        //                    tag = tagStack.Pop();
        //                }
        //                else
        //                {
        ...
        //                {
        //                    int n = "<color=".Length;
        //                    var color = tag.Substring(n, tag.Length-n-1);
        //                    tag = $"<color={color}>";
        ...
        //        {
        //            var bolck = lines[i];
        //            if(bolck.tag.Length != 0)
        //            {
        //                fixTest.Append(bolck.tag);
        //            }
        //            fixTest.Append(bolck.text);
        //            if (bolck.tag.Length != 0)
        //            {
